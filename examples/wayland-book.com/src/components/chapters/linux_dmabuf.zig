...
pub fn LinuxDmabuf() void {
    forbear.component(.{})({
        ...
        List()({
            ListItem()({
                forbear.text("Use ");
                Strong()({ forbear.text("eglGetPlatformDisplayEXT"); });
                forbear.text(" in concert with ");
                Strong()({ forbear.text("EGL_PLATFORM_WAYLAND_KHR"); });
            ...
            ListItem()({
                ...
                Strong()({ forbear.text("EGL_SURFACE_TYPE"); });
                forbear.text(" set to ");
                Strong()({ forbear.text("EGL_WINDOW_BIT"); });
                forbear.text(".");
            });
            ListItem()({
                forbear.text("Use ");
                Strong()({ forbear.text("wl_egl_window_create"); });
                forbear.text(" to create a ");
                Strong()({ forbear.text("wl_egl_window"); });
            ...
            ListItem()({
                forbear.text("Use ");
                Strong()({ forbear.text("eglCreatePlatformWindowSurfaceEXT"); });
                forbear.text(" to create an ");
                Strong()({ forbear.text("EGLSurface"); });
                forbear.text(" for a ");
                Strong()({ forbear.text("wl_egl_window"); });
                forbear.text(".");
            });
            ListItem()({
                ...
                Strong()({ forbear.text("eglMakeCurrent"); });
                forbear.text(" to make current the EGL context for your surface and ");
                Strong()({ forbear.text("eglSwapBuffers"); });
        ...
        Paragraph(.{})({
            ...
            Strong()({ forbear.text("wl_egl_window_resize"); });
            forbear.text(".");
        });
        ...
        Paragraph(.{})({
            ...
            Strong()({ forbear.text("types/wlr_linux_dmabuf_v1.c"); });
