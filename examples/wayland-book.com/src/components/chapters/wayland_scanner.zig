...
pub fn WaylandScanner() void {
    forbear.component(.{})({
        ...
        Paragraph(.{})({
            ...
            Strong()({
                forbear.text("wayland-client-protocol.h");
            });
            forbear.text(" and ");
            Strong()({
                forbear.text("wayland-server-protocol.h");
            });
            forbear.text(" — though you normally include ");
            Strong()({
                forbear.text("wayland-client.h");
            });
            forbear.text(" and ");
            Strong()({
                forbear.text("wayland-server.h");
            });
        ...
        Paragraph(.{})({
            ...
            Strong()({
                forbear.text("wayland-scanner -h");
            });
        ...
        Paragraph(.{})({
            ...
            Strong()({
                forbear.text("/usr/share/wayland");
            });
