...
pub fn FrameCallbacks() void {
    forbear.component(.{})({
        ...
        List()({
            ListItem()({
                forbear.text("Destroy the now-used frame callback.");
            });
            ListItem()({
                forbear.text("Request a new callback for the next frame.");
            });
            ListItem()({
                forbear.text("Render and submit the new frame.");
            });
        });
        ...
        List()({
            ...
            ListItem()({
                forbear.text("Commit the surface.");
            });
        });
